...
import { FeatureCleanupProcessor } from "./processors/feature-cleanup";
import { FileTransformProcessor } from "./processors/file-transform";
import { GitInitProcessor } from "./processors/git-init";
