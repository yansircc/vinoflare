...
function QuoteDetail() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <h1 className="mb-10 text-center font-light text-2xl text-gray-900">留言详情</h1>
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div className="mb-6 border-gray-100 border-b pb-6">
          <div className="mb-2">
            <h2 className="font-semibold text-gray-900 text-xl">{quote.name}</h2>
          </div>
          <div className="text-gray-600">{quote.email}</div>
          <div className="mt-2 text-gray-400 text-sm">
            发表于 {quote.createdAt ? new Date(quote.createdAt).toLocaleString('zh-CN', {
              year: 'numeric',
              month: 'long',
              day: 'numeric',
              hour: '2-digit',
