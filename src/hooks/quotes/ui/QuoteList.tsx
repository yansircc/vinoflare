import { useDeleteQuote, useQuotes } from "@/hooks/quotes/api";
import { QuoteForm } from "@/hooks/quotes/ui/QuoteForm";
...
export function QuotesList() {
	...
	return (
		<div className="mx-auto max-w-4xl">
			...
			{/* 技术栈说明 */}
			<div className="mt-8 border-gray-100 border-t pt-8">
				<div className="text-center">
					<div className="flex items-center justify-center gap-2 text-gray-400 text-xs">
						...
						<span>数据存储：Cloudflare D1</span>
					</div>
					<p className="mt-1 text-gray-400 text-xs">边缘 SQL 数据库</p>
				</div>
			</div>
		</div>
	);
