...
export const getGetApiTasksQueryOptions = <
	TData = Awaited<ReturnType<typeof getApiTasks>>,
	TError = unknown,
>(options?: {
	query?: Partial<
		UseQueryOptions<Awaited<ReturnType<typeof getApiTasks>>, TError, TData>
	>;
	fetch?: RequestInit;
}) => {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiTasks>>> = ({
		signal,
	}) => getApiTasks({ signal, ...fetchOptions });
...
export type GetApiTasksQueryResult = NonNullable<
	Awaited<ReturnType<typeof getApiTasks>>
>;
export type GetApiTasksQueryError = unknown;

export function useGetApiTasks<
	TData = Awaited<ReturnType<typeof getApiTasks>>,
	TError = unknown,
>(
	options: {
...
export const postApiTasks = async (
	postApiTasksBody: PostApiTasksBody,
	options?: RequestInit,
): Promise<PostApiTasks200> => {
	const res = await fetch(getPostApiTasksUrl(), {
		...options,
		method: "POST",
		headers: { "Content-Type": "application/json", ...options?.headers },
		body: JSON.stringify(postApiTasksBody),
	});
...
export const getPostApiTasksMutationOptions = <
	TError = PostApiTasks422,
	TContext = unknown,
>(options?: {
...
export type PostApiTasksMutationResult = NonNullable<
	Awaited<ReturnType<typeof postApiTasks>>
>;
export type PostApiTasksMutationBody = PostApiTasksBody;
export type PostApiTasksMutationError = PostApiTasks422;

export const usePostApiTasks = <TError = PostApiTasks422, TContext = unknown>(
	options?: {
		mutation?: UseMutationOptions<
			Awaited<ReturnType<typeof postApiTasks>>,
			TError,
...
export const getGetApiTasksIdQueryOptions = <
	TData = Awaited<ReturnType<typeof getApiTasksId>>,
	TError = GetApiTasksId404 | GetApiTasksId422,
>(
	id: number | null,
	options?: {
		query?: Partial<
			UseQueryOptions<Awaited<ReturnType<typeof getApiTasksId>>, TError, TData>
		>;
		fetch?: RequestInit;
	},
) => {
	...
	const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiTasksId>>> = ({
		signal,
	}) => getApiTasksId(id, { signal, ...fetchOptions });
...
export type GetApiTasksIdQueryResult = NonNullable<
	Awaited<ReturnType<typeof getApiTasksId>>
>;
export type GetApiTasksIdQueryError = GetApiTasksId404 | GetApiTasksId422;

export function useGetApiTasksId<
	TData = Awaited<ReturnType<typeof getApiTasksId>>,
	TError = GetApiTasksId404 | GetApiTasksId422,
>(
	id: number | null,
...
export const patchApiTasksId = async (
	id: number | null,
	patchApiTasksIdBody: PatchApiTasksIdBody,
	options?: RequestInit,
): Promise<PatchApiTasksId200> => {
	const res = await fetch(getPatchApiTasksIdUrl(id), {
		...options,
		method: "PATCH",
		headers: { "Content-Type": "application/json", ...options?.headers },
		body: JSON.stringify(patchApiTasksIdBody),
	});
...
export const getPatchApiTasksIdMutationOptions = <
	TError = PatchApiTasksId404 | PatchApiTasksId422,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
...
export type PatchApiTasksIdMutationResult = NonNullable<
	Awaited<ReturnType<typeof patchApiTasksId>>
>;
export type PatchApiTasksIdMutationBody = PatchApiTasksIdBody;
export type PatchApiTasksIdMutationError =
	| PatchApiTasksId404
	| PatchApiTasksId422;
...
export const getDeleteApiTasksIdMutationOptions = <
	TError = DeleteApiTasksId404 | DeleteApiTasksId422,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
...
export type DeleteApiTasksIdMutationError =
	| DeleteApiTasksId404
	| DeleteApiTasksId422;

export const useDeleteApiTasksId = <
	TError = DeleteApiTasksId404 | DeleteApiTasksId422,
	TContext = unknown,
>(
	options?: {
